...
public class QuickPopup extends PopupWindow {
    ...
    public static class Builder {
        ...
        public QuickPopup show(View anchorView, int xOffset, int yOffset) {
            ...
            int[] windowPos = calculatePopWindowPos(anchorView, popup.getRootView());
            //x 轴偏移像素
            windowPos[0] += xOffset;
            //y 轴偏移像素
            windowPos[1] += yOffset;
        ...
        private int[] calculatePopWindowPos(final View anchorView, View popView) {
            ...
            // 判断需要向上弹出还是向下弹出显示
            final boolean isNeedShowUp = (screenHeight - anchorLoc[1] - anchorHeight < popViewHeight);
            if (isNeedShowUp) {
