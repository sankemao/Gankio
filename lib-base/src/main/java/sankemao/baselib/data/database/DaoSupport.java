package sankemao.baselib.data.database;
...
import sankemao.baselib.data.database.curd.QuerySupport;
...
public class DaoSupport<T> implements IDaoSupport<T> {
    ...
    public void init(SQLiteDatabase sqLiteDatabase, Class<T> clazz) {
        ...
        //2016.10.16: InstantRun打开会给类添加$change属性(解决办法： 关闭instantRun或者判断一下这个属性，类型是null.)
