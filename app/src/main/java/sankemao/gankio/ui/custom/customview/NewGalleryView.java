...
import sankemao.gankio.ui.custom.photoview.PhotoView;

/**
 * Description: TODO
 * Create Time: 2018/4/27.17:02
 * Author:jin
 * Email:210980059@qq.com
 */
public class NewGalleryView extends PhotoView {
    ...
    public NewGalleryView(Context context, AttributeSet attr) {
        super(context, attr);
    }

    public NewGalleryView(Context context, AttributeSet attr, int defStyle) {
    ...
    public void draw(Canvas canvas) {
        if (clipBounds != null) {
            ...
            LogUtils.i("clip", "clipBounds  >>  " + clipBounds.toShortString());
            clipBounds = null;
        }
        super.draw(canvas);
    }
    ...
    private void playExitAnimaInternal(final Rect to, @Nullable View alphaView) {
        if (isPlayingEnterAnima || to == null || getAttacher() == null) {
    ...
    /**
     *
     * @param from              当前大图View的尺寸
     * @param drawableBounds    当前大图drawable的尺寸
     * @param target            目标小图View的尺寸
     * @return                  缩放比例
     */
    ...
    public Rect getViewBounds() {
        ...
        LogUtils.i(result.toShortString());
        return result;
    }
    ...
    private class BitmapTransform implements Runnable {
        ...
        void animaTranslate(int fromX, int toX, int fromY, int toY) {
            ...
            LogUtils.i("animaTranslate", (toX - fromX), (toY - fromY));
        }
        ...
        void animaClip(Rect clipFrom, Rect clipTo) {
            ...
            LogUtils.i("clip", "clipFrom  >>>  " + clipFrom.toShortString());
            LogUtils.i("clip", "clipTo  >>>  " + clipTo.toShortString());
        ...
        public void run() {
            ...
            if (translateScroller.computeScrollOffset()) {
                ...
                LogUtils.i("animaTranslate", dx, dy);
