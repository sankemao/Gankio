 ...
 *******************************************************************************/
package sankemao.gankio.ui.custom.photoview;
...
public class PhotoView extends ImageView {
    ...
    public void postMatrixScale(float scaleX, float scaleY, float centerX, float centerY) {
        attacher.postMatrixScale(scaleX, scaleY, centerX, centerY);
    }

    public void postMatrixScale(float scaleX, float scaleY) {
        attacher.postMatrixScale(scaleX, scaleY);
    }

    public void postMatrixTranslate(float dx, float dy) {
        attacher.postMatrixTranslate(dx, dy);
    }

    public void applyMatrix() {
        attacher.applyMatrix();
    }
    //===========================================================================================
