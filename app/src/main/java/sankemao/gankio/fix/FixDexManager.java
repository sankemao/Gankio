...
public class FixDexManager {
    ...
    public void fixDex(String fixDexPath) throws Exception {
        ...
        File destFile = new File(mDexDir, "copyDexDir");

        if (!destFile.exists()) {
            destFile.mkdirs();
        }

        FileUtils.copyDir(srcFile, destFile, new FileUtils.OnReplaceListener() {
            @Override
    ...
    private void fixDexFiles(List<File> fixDexFiles) throws Exception {
        ...
        File optimizedDirectory = new File(mDexDir, "oDexDir");
